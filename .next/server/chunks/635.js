...
/* harmony import */ var _config_apiConfig__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6446);
...
class CarService {
    ...
    bookTrial(payload1) {
        return _utils_axiosInstance__WEBPACK_IMPORTED_MODULE_1__/* ["default"].post */ .Z.post(`/trial`, payload1);
    }
    getInpectionsById(payload2) {
        return _utils_axiosInstance__WEBPACK_IMPORTED_MODULE_1__/* ["default"].get */ .Z.get(`/sellCar/getBy/UserId/${payload2}`);
    }
}
...
/* harmony import */ var _config_apiConfig__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6446);
/* harmony import */ var _getAccessToken__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9877);
