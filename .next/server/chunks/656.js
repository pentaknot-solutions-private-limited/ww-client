...
/* harmony default export */ const arrow_right = ({"src":"/_next/static/media/arrow-right.d9f12859.svg","height":16,"width":16});
...
function SiteButton({ text , arrow , onClick , buttonVariant , styles , disabled , type  }) {
    return(/*#__PURE__*/ (0,jsx_runtime_.jsxs)(StyledButton, {
        ...
        children: [
            text,
            arrow == true ? /*#__PURE__*/ jsx_runtime_.jsx(next_image["default"], {
                src: arrow_right,
                height: 16,
                width: 16,
                alt: "arrow-right"
