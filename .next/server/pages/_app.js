...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"src":"/_next/static/media/wishwheels-logo.c1e90826.svg","height":26,"width":30});
...
var wishwheels_logo = __webpack_require__(2191);
...
var apiConfig = __webpack_require__(6446);
...
class OtpService {
    ...
    verifyOtp(payload1) {
        return external_axios_default().post(`${apiConfig/* APIURL */.z}/otp/verifyOtp`, payload1);
    }
}
...
var AuthContext = __webpack_require__(1037);
...
/* harmony default export */ const apple_share_icon = ({"src":"/_next/static/media/apple-share-icon.ebfcd552.svg","height":512,"width":512});
...
function MyApp({ Component , pageProps  }) {
    ...
    const { 0: installPrompt , 1: setInstallPrompt  } = (0,external_react_.useState)(null);
    const { 0: installButton , 1: setInstallButton  } = (0,external_react_.useState)(false);
    const { 0: isIos , 1: setIsIos  } = (0,external_react_.useState)(true);
    const { 0: hidePopup , 1: setHidePopup  } = (0,external_react_.useState)(false);
    const { 0: openModel , 1: setOpenModel  } = (0,external_react_.useState)(false);
    // Variables
...
window.dataLayer = window.dataLayer || [];
  ...
  gtag('config', 'G-SM7H9X2PXT');
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(styles_.ThemeProvider, {
                theme: src_theme,
                children: /*#__PURE__*/ jsx_runtime_.jsx(AuthContext/* default.Provider */.Z.Provider, {
                    value: {
                        authenticated,
                        setAuthenticated
                    },
                        ...
                        children: [
                            ...
                            isIos && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx(InstallPWAModel, {
                                        open: openModel,
...
var __webpack_exports__ = __webpack_require__.X(0, [675,664,656,235], () => (__webpack_exec__(8373)));
