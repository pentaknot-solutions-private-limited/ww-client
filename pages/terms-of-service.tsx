    ...
    <section className="default-page">
      <Container maxWidth="lg">
        ...
        <p>
          ...
          shall manage your use of our website, www.wishwheels.com accessible at
          www.wishwheels.com.
        </p>
        ...
        <p>
          Other than the content you own, under these Terms, Wish Wheels and/or
        ...
        <p>
          ...
          and Wish Wheels may further restrict access by you to any areas of
        ...
        <p>
          ...
          display on this Website. By displaying Your Content, you grant Wish
          Wheels a non-exclusive, worldwide irrevocable, sub licensable license
        ...
        <p>
          ...
          third-party’s rights. Wish Wheels reserves the right to remove any of
        ...
        <p>
          This Website is provided as is, with all faults, and Wish Wheels
        ...
        <p>
          In no event shall Wish Wheels, nor any of its officers, directors and
          ...
          under contract.  Wish Wheels, including its officers, directors and
        ...
        <p>
          You hereby indemnify to the fullest extent Wish Wheels from and
        ...
        <p>
          Wish Wheels is permitted to revise these Terms at any time as it sees
        ...
        <p>
          The Wish Wheels is allowed to assign, transfer, and subcontract its
        ...
        <p>
          These Terms constitute the entire agreement between Wish Wheels and
